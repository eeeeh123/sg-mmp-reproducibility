...
| Direct GSM8K-500 comparison and Figure 2 | `data/processed/gsm8k500/`, `data/processed/source_artifacts/experiments/fix_gsm8k_500/results_direct/`, `scripts/analyze_released_gsm8k500.py` |
| Bit-budget table | `experiments/analysis/bit_budget.py`, manuscript source |
...
use `SmolLM-1.7B`; see `docs/model_provenance.md` for the checkpoint identity.
